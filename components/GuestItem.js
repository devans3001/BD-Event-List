...
export default function GuestItem({ guest }) {
  ...
  return (
    <div className={`p-3 md:p-6 rounded-lg border-2 transition-all duration-200 shadow-sm ${
      guest.arrived 
      ...
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          className={`px-3 md:px-6 py-1.5 rounded-lg font-medium transition-colors  ${
            guest.arrived
